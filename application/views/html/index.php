        ...
        <div class="row">
            ...
            <div class="col-md-7 col-sm-12">
                ...
                <div class="who-list col-md-4">
                    ...
                    <div class="who-content">
                        <h4>donation</h4>
                        <p>Making a donation is the ultimate sign of solidarity. Actions speak louder than words. Each rupee of your donation will be helping us in supporting the people who are in need.</p>
                ...
                <div class="who-list col-md-4">
                    ...
                    <div class="who-content">
                        <h4>volunteers</h4>
                        <p>We believe that each individual contribution helps in building a better society. We value and appreciate your time and initiative.</p>
                    </div>
                </div>
                <!-- Who List End -->
                <!-- Who List Start -->
                <div class="who-list col-md-4">
                    ...
                    <div class="who-content">
                        <h4>fundraise</h4>
                        <p>Fundraising events are a powerful way to grow your community, engage with donors, give supporters a positive experience with your organisation.</p>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="section-heading section-heading1">
                    ...
                    <p>Mss conducts various helpful events for poor & needy people</p>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <div class="counter-list">
                    ...
                    <div class="counter-content">
                        <h3 class="">
                            <?php echo isset($volunters_list)?count($volunters_list):''; ?>
                        </h3>
                        <p>volunteers</p>
                    </div>
                </div>
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <div class="counter-list">
                    ...
                    <div class="counter-content">
                        <h3 class="">
                            <?php echo isset($event_list)?count($event_list):''; ?>
                        </h3>
                        <p>Events</p>
                    </div>
                </div>
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <div class="counter-list">
                    ...
                    <div class="counter-content">
                        <h3 class="">
                            <?php echo isset($certificates_list)?count($certificates_list):''; ?>
                        </h3>
                        <p>Certificates</p>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="section-heading">
                    ...
                    <p>Our work would not be possible without the support of our dedicated volunteers. Volunteers helping us to reach more people across the India and engaging them in our work and events. </p>
                </div>
                <!-- Section heading End -->
            </div>
        </div>
...
<section id="portfolio" class="gallery section-padding section-bg-clr1">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <!-- Section Heading Start -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <!-- Section Heading Start -->
                <div class="section-heading">
                    <h2>Regular <span>donars</span></h2>
                    <span>
                        <img src="<?php echo base_url(); ?>assets/vendor/images/icon.png" alt="icon">
                    </span>
                </div>
                            ...
                            <div class="upcoming-list">
                                ...
                                <div class="upcoming-text">
                                    <h4><a href="javascript:void(0);">
                                            <?php echo isset($li['title'])?$li['title']:''; ?></a></h4>
                                    <p>
                                        <?php echo isset($li['description'])?substr($li['description'], 0, 20):''; ?>
                                    </p>
                                    <div class="upcoming-comment">
                                        <ul>
                                            <li><i class="fa fa-clock-o" aria-hidden="true"></i><span>
                                                    <?php echo isset($li['date'])?$li['date']:''; ?></span></li>
                                            <li><i class="fa fa-map-marker" aria-hidden="true"></i><span>
                                                    <?php echo isset($li['address'])?$li['address']:''; ?></span></li>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="section-heading">
                    ...
                    <p>This is a space for members of the Charity works team and network to share their stories, thoughts and news about the programme and the world of social change.</p>
                    ...
                    <div class="blog-content">
                        ...
                        <div class="blog-text">
                            <h3><a href="blog-single.html">
                                    <?php echo isset($li['title'])?$li['title']:''; ?></a></h3>
                            <p>
                                <?php echo isset($li['description'])?$li['description']:''; ?>
                            </p>
                        ...
                        <div class="blog-comment">
                            <ul>
                                <li>
                                    ...
                                    <span> - by
                                        <?php echo isset($li['name'])?$li['name']:''; ?></span>
                                </li>
