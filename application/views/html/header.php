...
<head>
    ...
    <title>Mithra Seva Samithi</title>
    <!--Favicon add-->
    <link rel="shortcut icon" type="image/png" href="<?php echo base_url(); ?>assets/vendor/images/icon.png">
    <!--bootstrap Css-->
                                ...
                                <div class="header-top-left">
                                    <ul>
                                        <li>
                                            ...
                                            <p>
                                                <a href="#">contact@mithraseva.com</a>
                                            </p>
                                        </li>
                            ...
                            <div class="navbar-menu">
                                <div class="navbar-header">
                                    ...
                                    <a class="navbar-brand" href="<?php echo base_url(); ?>">
                                        <img src="<?php echo base_url(); ?>assets/vendor/images/logo.png" alt="logo">
                                    </a>
                                </div>
