                            ...
                            <!-- footer-list start -->
                                <div class="col-xs-12 col-sm-6 col-md-4">
                                        ...
                                        <div class="footer-item">
                                            <div class="footer-header " style="background-color:#fff;padding:10px 50px;border-radius:25px;">
                                                <img width="160px;" class="img-responsive" src="<?php echo base_url(); ?>assets/vendor/images/logo.png" alt="footer">
                                            </div><!-- footer header-->
            ...
            <div class="footer-copyright">
                <div class="footer-copyright1">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <p>© 2018 <a href="#">Mithra Seva Samithi</a>. All rights reserved.</p>
                            </div>
