...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Reset Password your session</p>
						...
						<div class="">
						  ...
						  <div class="form-group">
							...
							<div class="col-md-12">
                                <button type="submit" class="btn btn-primary pull-right" name="signup" value="Sign up">Reset Password</button>
